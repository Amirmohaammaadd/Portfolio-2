...
export const ABOUT_TEXT =
  "I am a dedicated and versatile Front-end developer with a passion for creating efficient and user-friendly web applications. With 3 years of professional experience, I have worked with a variety of technologies, including React, Next.js, typescript, MySQL. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, exploring new technologies, and contributing to open-source projects.";
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project3,
    description:
      "Developed a responsive shopping website with React and Next.js, featuring a user-friendly interface, persistent cart functionality, and seamless product browsing. Integrated Ant Design for design consistency and localStorage for data retention across sessions.",
    technologies: ["Antd", "tailwind", "React", "Next.js"],
  },
  {
    title: "Snapp-food website",
    image: project1,
    description:
      "Designed and developed a responsive food delivery website using React and Next.js, with real-time order tracking and intuitive navigation. Integrated Ant Design for a polished UI and implemented features for seamless menu browsing and secure checkout",
    technologies: ["Javascript", "React.js", "Next.js"],
  },
  {
    title: "Azki.com website",
    image: project2,
    description:
      "Built a professional insurance website with React and Next.js, featuring policy comparison tools and a streamlined quote generation process. Integrated Ant Design for a modern interface and optimized the user journey for seamless navigation and accessibility.",
    technologies: ["Js", "React", "antD"],
  },
];
